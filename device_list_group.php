 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Group Assets <span id="showgroupname"></span></h1>         
            </div>
...
<div class="modal fade" id="modal_approve">
 ...
 <!-- /.modal-approve -->
  ...
  $(function () {
    ...
    getgroupemps($("#sent_grp_id").val());


    function getgroupemps(gpid){
      $.ajax({  
      url: "get_device_list_group.php",
      type: "POST",
      data: {operation:"alllistemp",grpid:gpid},beforeSend: function(){
        $(".toastctrl").fadeOut();
      
      },
      success: function(response){
        //console.log(response);
        $("#showemps").html(response);
  ...
  $("body").on("click", ".getpc", function (e) {
          id = $(this).data('pcid');
          $.ajax({
        type : 'post',
        url : 'get_pcs.php',
        ...
        $("body").on("click", ".getprinter", function (e) {
          id = $(this).data('prntid');
          $.ajax({
        type : 'post',
        url : 'get_pcs.php',
