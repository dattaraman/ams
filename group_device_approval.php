 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">[GROUP] Device Approval</h1>         
            </div>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
              <div class="row">
                  <div class="col-lg-12 text-right"><input type="text" name="filteremp" id="filteremp" class="form-control" placeholder="Filter by Employee name"></div>
              </div>
              <hr>
