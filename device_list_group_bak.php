...
<head>
  ...
  <title>SIRD | [GROUP] Device Approval</title>
  <style>
  .error{color:#ff0000;}
  </style>
</head>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <input type="hidden" name="sent_grp_id" id="sent_grp_id" value="<?=$_POST['grpid'];?>">
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
...
<div class="modal fade" id="modal_approve">
        ...
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <button type="button" class="btn btn-primary" id="approveBtnDevice">Approve</button>
              <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
              </div>
 ...
 <!-- /.modal-approve -->
  ...
  $(function () {
    ...
    getgroupc($("#sent_grp_id").val());
    getgroupdevice($("#sent_grp_id").val());
...
function groupadmin_mark_approve(id){
  //alert(id);
  $.ajax({  
      url: "get_device_approval_group.php",
      type: "POST",
      data: {operation:"group_mark_approve",id:id},beforeSend: function(){
...
function groupadmin_mark_approvedevice(id){
  //alert(id);
  $.ajax({  
      url: "get_device_approval_group.php",
      type: "POST",
      data: {operation:"group_mark_approvedevice",id:id},beforeSend: function(){
...
$("#approveBtn").click(function(){
  groupadmin_mark_approve($("#approveid").val());
});


$("#approveBtnDevice").click(function(){
  groupadmin_mark_approvedevice($("#approveiddevice").val());
});
  
    function getgroupc(gpid){
     
      $.ajax({  
      url: "get_device_list_group.php",
      type: "POST",
      data: {operation:"alllist",grpid:gpid},beforeSend: function(){
        $(".toastctrl").fadeOut();
    ...
    function getgroupdevice(gpid){
     
     $.ajax({  
     url: "get_device_list_group.php",
     type: "POST",
     data: {operation:"alllistdevice",grpid:gpid},beforeSend: function(){
       $(".toastctrl").fadeOut();
